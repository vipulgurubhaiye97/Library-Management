<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BookAssign.aspx.cs" Inherits="BookAssign" %>
...
.td_book,td_student{border:1px solid #a4a4a4;}
.td_1{ width:200px; padding:3px 15px 3px 3px; background:#fafafa; text-align:right; border:1px solid #a4a4a4a;}
.txtbox{width:200px; padding:3px;}
.btn{ background:#6699cc; border:1px solid #6699cc; padding:5px 1-px 5px 10px; color:#ffffff;}
.btn:hover{ background:#ea6153; border:1px solid #ea6153; padding:5px 10px 5px 10px; color:#fffff;}
.td_b_11{width:200px; padding:3px 15px 3px 3px; text-align:right; border-left:1px solid #a4a4a4;}
.td_b_22{ width:250px; padding:3px ; border-right:1px solid #4a4a4a;}
.td_b_11_last{ width;200px; padding:3px 15px 3px 3px; text-align:right; border-left:1px solid #a4a4a4; border-bottom:1px solid #a4a4a4;}
.td_b_22_last{ width:250px; padding:3px; border-right:1px solid #a4a4a4; border-bottom:1px solid #a4a4a4;} 
...
<div style="background:#ffffff; margin-top:-15px; height:500px; padding:10px 25px 50px 25px;">
 ...
 <caption><h1>Book Assigning to Student</h1></caption>
