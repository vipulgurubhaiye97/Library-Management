...
{
    SqlConnection con = new SqlConnection("Data Source=DELL-PC;Initial Catalog=Library;Integrated Security=True");
    SqlCommand cmd;
    SqlDataAdapter da;
    DataSet ds;
    string qr;
    ...
    protected void btn_Add_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            qr = "Insert into BookRecord(bookid, bookname, bookpubname, bookpubyear, bookprice, bookquantity, recorddate) values('" + txt_bookid.Text.Trim() + "','" + txt_bookname.Text.Trim() + "','" + txt_bookpubname.Text.Trim() + "','" + txt_bookpubyear.Text.Trim() + "','" + txt_bookprice.Text.Trim() + "','" + txt_bookqty.Text.Trim() + "','" + DateTime.Today.Date.ToShortDateString() + "')";
        ...
        {
            con.Close();
            Response.Write("alert('Exception occur')");
        }
    }
    ...
    protected void btn_check_Click(object sender, EventArgs e)
    {
        try
        {
           qr = "Select * from BookRecord Where bookid='" + txt_edit_bookid.Text.Trim() + "'";
    ...
    protected void btn_Update_Click(object sender, EventArgs e)
    {
        try
        {
            qr = "Update BookRecord set bookname='" + txt_edit_bookname.Text.Trim() + "', bookpubname='" + txt_edit_bookpubname.Text.Trim() + "', bookpubyear='" + txt_edit_bookpubdate.Text.Trim() + "', bookprice='" + txt_edit_bookprice.Text.Trim() + "', bookquantity='" + txt_edit_bookqty.Text.Trim() + "' where bookid='" + txt_edit_bookid.Text.Trim() + "'";
            cmd = new SqlCommand(qr, con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
    ...
    protected void btn_Delete_Click(object sender, EventArgs e)
    {
        try
        {
            qr = "Delete BookRecord where bookid='" + txt_delete_bookid.Text.Trim() + "'";
            cmd = new SqlCommand(qr, con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
